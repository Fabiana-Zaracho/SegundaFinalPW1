...
urlpatterns = [
    ...
    path('carrera_pdf_list/', views.carrera_pdf_list, name='carrera_pdf_list'),  # Ruta agregada
    path('asignar_dificultad/', views.asignar_dificultad, name='asignar_dificultad'),  # Ruta agregada
]
