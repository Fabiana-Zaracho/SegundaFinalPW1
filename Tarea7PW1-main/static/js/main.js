        ...
        if (data.message === "Success") {
            ...
            datamateria.cursos.forEach(curso => {
                ...
                datamateria.semestres.forEach(semestre => {                              
                    ...
                    materiasCursoSemestre.forEach((materia) => {
                        checkboxes += `
                            <tr>
                                ...
                                <td>${materia.dificultad || 'No especificado'}</td> <!-- Añadido campo de dificultad -->
                            </tr>
                        `;
                    });
                    ...
                    tdheaddificultad.textContent = 'Dificultad'; // Columna de dificultad

                    const tdheadinput = document.createElement('td');
                    const checkhead = `<input class="form-check-input" type="checkbox" id="checkGeneral-${curso}-${semestre}" onclick="toggleCheckboxes(this,'${curso}', '${semestre}')">`;
                    ...
                    trhead.appendChild(tdheaddificultad); // Agregar columna de dificultad
